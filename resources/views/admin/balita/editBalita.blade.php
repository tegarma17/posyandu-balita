                ...
                <div class="flex flex-wrap mx-3 mb-6">
                    ...
                    <div class="w-full md:w-1/3 px-3 mb-6 md:mb-0">
                        ...
                        <input
                            ...
                            value="{{ old('no_kk_ortu', $balita->nik_ortu) }}">
                    </div>
                </div>
                <div class="flex flex-wrap mx-3 mb-6">
                            ...
                            <select
                                ...
                                @foreach ($provinsi as $prov)
                                    <option value="{{ $prov->id }}"
                                        {{ $balita->desa->kecamatan->ktkbp->provinsi->id == $prov->id ? 'selected' : '' }}>
                                        Jawa Timur
                                    </option>
                                @endforeach
                        ...
                        <div class="relative">
                            <select
                                ...
                                @foreach ($ktkbp as $ktkb)
                                    <option value="{{ $ktkb->id }}"
                                        {{ $balita->desa->kecamatan->ktkbp->id == $ktkb->id ? 'selected' : '' }}>
                                        {{ $ktkb->nama }}
                                    </option>
                                @endforeach
                            </select>
                            ...
                            <select
                                ...
                                @foreach ($kcmtn as $kecamatan)
                                    <option value="{{ $kecamatan->id }}"
                                        {{ $balita->desa->kecamatan_id == $kecamatan->id ? 'selected' : '' }}>
                            ...
                            <select
                                ...
                                @foreach ($desa as $dsa)
                                    <option value="{{ $dsa->id }}" data-kecamatan="{{ $dsa->kecamatan_id }}"
                                        {{ $balita->desa_id == $dsa->id ? 'selected' : '' }}>
                                        {{ $dsa->nama }}</option>
                                @endforeach
                            </select>
                            <div
